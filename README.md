...
Реализуемые оптимизации будут предполагать знание ассемблера и вставки ассемблерного кода, что значительно ухудшает "читабельность" и понимание кода. Поэтому будем рассчитывать "коэффициент полезного действия" оптимизации: $$K = \frac{a_{абс}{N} · 1000},$$
