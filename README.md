...
Распределение выглядит довольно равномерным, что подтверждает полученная дисперсия: $D = 8.496845$.
...
Посчитанная для большой таблицы дисперсия - $D = 8.962102$ - больше, чем в случае маленькой таблицы, что подтверждает, что эта хэш-функция не так хороша, как показалось сначала.
